...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://cdn.jsdelivr.net/gh/wudongdefeng/jd-temporary@main/jd_updateFactoryTuanId.json")
...
function updateTuanIdsCDN(url = 'https://cdn.jsdelivr.net/gh/wudongdefeng/jd-temporary@main/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
